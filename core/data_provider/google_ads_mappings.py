# google_ads_mappings.py

"""
This file provides mappings for Google Ads API geo-target and language codes.
It includes dictionaries to convert between names (e.g., 'United States', 'English')
and their corresponding numerical IDs required by the API.
"""

# Dictionary to map country names to their geo-target IDs
GEO_TARGET_MAP = {
    'Afghanistan': '2004',
    'Albania': '2008',
    'Antarctica': '2010',
...
# Dictionary to map language names to their language codes
LANGUAGE_MAP = {
    'Arabic': '1019',
    'Bengali': '1056',
    'Bulgarian': '1020',
...
# from ID to name if needed.
GEO_TARGET_REVERSE_MAP = {v: k for k, v in GEO_TARGET_MAP.items()}
LANGUAGE_REVERSE_MAP = {v: k for k, v in LANGUAGE_MAP.items()}

# Example usage:
# print(f"Geo-target ID for 'United States': {GEO_TARGET_MAP['United States']}")
# print(f"Language ID for 'English': {LANGUAGE_MAP['English']}")
# print(f"Country name for geo-target ID '2840': {GEO_TARGET_REVERSE_MAP['2840']}")